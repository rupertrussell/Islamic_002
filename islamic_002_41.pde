...
float testY = 0.3882;
int counter = 0;
int guideLines = 150; // greyscale for guide lines  stroke(guideLines);
...
int innerWeight = 10; // thicknes of inner stroke
...
void draw() {
  ...
  stroke(0);
  drawTheCross(outerWeight); // Outer black lines
  stroke(255,255,0);
  drawTheCross(innerWeight); // inner white iines
  ...
  starPoints();  // set the values for the star sturning points
